 ...
 */
?>
<div class="<?php print $classes; ?> customframeblock rollover-block rollover2-block" id="block-<?php print $block->module; ?>-<?php print $block->delta; ?>"<?php print $attributes; ?>>
    <div class="boxborder">
    <div class="bi">
