...
<div id="page">
  <div id="masthead">
    ...
    <div class="clearfix" id="middlecontainer">
      ...
      <div id="main">
        <div id="squeeze">
          <?php if (theme_get_setting('hdpt_breadcrumb')): ?>
            <?php if ($breadcrumb): ?>
              <div id="breadcrumb">
...
<?php if ($page['footer'] || $page['footer_message'] || theme_get_setting('hdpt_banner')): ?>
  <div id="footer"> 
...
<?php
  ...
  if ($page['user7'])  { $section2count++; }
  if ($page['user8'])  { $section2count++; }
